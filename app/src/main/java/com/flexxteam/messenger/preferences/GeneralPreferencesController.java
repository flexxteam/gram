...
public class GeneralPreferencesController extends RecyclerViewController<Void> implements View.OnClickListener {

  private SettingsAdapter adapter;

  public GeneralPreferencesController (Context context, Tdlib tdlib) {
    super(context, tdlib);
  }

  @Override public CharSequence getName () {
    return Lang.getString(R.string.GeneralPreferences);
  }

  @Override public int getId () {
    return R.id.controller_GeneralPreferences;
  }
