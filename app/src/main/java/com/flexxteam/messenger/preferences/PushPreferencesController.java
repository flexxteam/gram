...
public class PushPreferencesController extends RecyclerViewController<Void> implements View.OnClickListener {

  private SettingsAdapter adapter;

  public PushPreferencesController (Context context, Tdlib tdlib) {
    super(context, tdlib);
  }
